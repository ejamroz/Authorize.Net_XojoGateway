#tag Class
Protected Class RT_AuthorizeAndCapture
Inherits AuthorizeNetAPI.TransactionRequest_
Implements Tokenizable
	#tag Method, Flags = &h0
		Sub constructor(amount as double, payType as AuthorizeNetAPI.PaymentType, optional billing as AuthorizeNetAPI.BillingProfile)
	...
	#tag Property, Flags = &h21
		Private paymentType As AuthorizeNetAPI.PaymentType
	#tag EndProperty
