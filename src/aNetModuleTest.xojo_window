...
Begin Window aNetModuleTest
   ...
   Begin Label Label2
      ...
      Width           =   99
   End
   Begin TextField TransactionKeyField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      ...
      Width           =   151
   End
   Begin PushButton AuthAndCaptureButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
   ...
   Begin Label Label10
      ...
      Width           =   73
   End
   Begin TextField MerchantIDField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin PushButton VoidButton
      ...
      Width           =   117
   End
   Begin PushButton CreateProfileButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   117
   End
   Begin PushButton ChargeProfileButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   True
      ...
      Width           =   117
   End
   Begin PushButton AddPaymentInfoButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   True
   ...
   Begin TextField TextField13
      ...
      Width           =   46
   End
   Begin PushButton GetPaymentInfoButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   117
   End
   Begin PushButton DeleteCustomerProfileButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   True
      ...
      Width           =   117
   End
   Begin PushButton UpdatePAymentInfoButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   True
      ...
      Width           =   117
   End
   Begin PushButton DeletePaymentInfoButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   True
      ...
      Width           =   117
   End
   Begin PushButton AuthAndCaptureTrack2Button
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
   ...
   Begin TextField LastnameField
      ...
      Width           =   142
   End
   Begin TextField PhoneNumberField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label Label23
      ...
      Width           =   100
   End
   Begin TextField CreditCardField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
      ...
      Width           =   142
   End
   Begin TextField ExpirationField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
      ...
      Width           =   142
   End
   Begin TextField ControlCodeField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin TextField Track2Field
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "5301250070000191=08051010912345678901"
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   12.0
      TextUnit        =   0
   ...
   Begin Label Label31
      ...
      Width           =   100
   End
   Begin TextField CompanyNameField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label Label35
      ...
      Width           =   107
   End
   Begin TextField TransactionIDField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
      ...
      Width           =   107
   End
   Begin TextField CustomerIDField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
      ...
      Width           =   107
   End
   Begin TextField ProfileIDField
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Function getBillingProfile() As BillingProfile
		  dim theName as Name = getName()
		  dim billingBuilder as new BillingProfileBuilder(theName)
		  
		  return billingBuilder._
		  setAddress(AddressField.text)._
		  setCity(CityField.text)._
		  setState(StateField.text)._
		  setZipCode(ZipCodeField.text)._
		  setCountry(CountryField.text)._
	...
	#tag Method, Flags = &h21
		Private Function getMerchantAuthoriztion() As MerchantAuthentication
		  return new MerchantAuthentication(MerchantIDField.text, TransactionKeyField.text)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Function getName() As Name
		  return new Name(FirstnameField.text, LastnameField.text)
		End Function
	#tag EndMethod
...
#tag Events AuthAndCaptureButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
...
#tag Events VoidButton
	...
	#tag EndEvent
#tag EndEvents
#tag Events CreateProfileButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events ChargeProfileButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events AddPaymentInfoButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events GetPaymentInfoButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events DeleteCustomerProfileButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events UpdatePAymentInfoButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events DeletePaymentInfoButton
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
	...
	#tag EndEvent
#tag EndEvents
#tag Events AuthAndCaptureTrack2Button
	#tag Event
		Sub Action()
		  self.TextArea1.Text = ""
...
#tag Events ANetTransactionManager1
	...
	#tag Event
		Sub ResponseRecieved(response as TransactionResponse)
		  ...
		  self.TransactionIDField.text = response.transactionID
...
#tag Events ANetProfileManager1
	...
	#tag Event
		Sub ResponseRecieved(response as ProfileResponse)
		  ...
		  if response.customerProfileID <> "" then 
		    CustomerIDField.text = response.customerProfileID
		    
		  end if
		  
		  if response.paymentProfileId <> "" then 
		    ProfileIDField.text = response.paymentProfileId
	...
	#tag EndEvent
#tag EndEvents
#tag Events TransactionIDField
	#tag Event
		Sub TextChange()
		  if me.text <> "" and me.text <> "0" then
...
#tag Events CustomerIDField
	...
	#tag EndEvent
#tag EndEvents
#tag Events ProfileIDField
	#tag Event
		Sub TextChange()
		  if me.text <> "" and me.Text <> "0" then
		    ChargeProfileButton.Enabled = true
		    DeletePaymentInfoButton.Enabled = true
		    UpdatePAymentInfoButton.Enabled = true
		    
		  else
		    DeletePaymentInfoButton.Enabled = false
		    UpdatePAymentInfoButton.Enabled = false
